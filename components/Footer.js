...
">
 ...
 <Image className="" src={logofooter.src} alt="" width={200} height={59}/>
        ...
        <p class="">
        TUROG Technologies is a digital transformation company that helps companies navigate the ever-evolving digital landscape and create successful strategies for their businesses. 
        </p>
      </div>
...
<svg className="w-13 mr-4 map-iconss" width="55" height="50" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6.99584 15.089L12.249 22.0926C12.648 22.6245 13.2838 22.9688 14 22.9688C14.7162 22.9688 15.352 22.6245 15.751 22.0926L21.0042 15.089C22.1005 13.6274 22.75 11.8114 22.75 9.84375C22.75 5.01129 18.8325 1.09375 14 1.09375C9.16748 1.09375 5.25 5.01129 5.25 9.84375C5.25 11.8114 5.89958 13.6274 6.99584 15.089Z" stroke="#FE6C47" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M16.1875 9.84375C16.1875 11.0519 15.2081 12.0312 14 12.0312C12.7919 12.0312 11.8125 11.0519 11.8125 9.84375C11.8125 8.63565 12.7919 7.65625 14 7.65625C15.2081 7.65625 16.1875 8.63565 16.1875 9.84375Z" stroke="#FE6C47" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M9.625 26.9062H18.375" stroke="#FE6C47" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

          3B Community Street, Medina Estate, Lagos, Nigeria
        </p>
          <p className="flex items-center justify-center md:justify-start mb-4 footer-para-linkss">
...
<rect width="21" height="21" fill="white"/>
        ...
        <a href='tel;+234 (802) 227-9770'> +234 (802) 227-9770</a>  
        </p>
         </div>
