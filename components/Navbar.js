...
function classNames(...classes) {
  ...
  const fetchFaq = async () => {
    let headers = {
      Authorization:"bearer ",
    };
    await axios.get("http://34.136.73.77:1339/api/website-info?populate=logo", {headers: headers,})
        ...
        <div className="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10 heder-tp-stripes">
          <div className="flex justify-start lg:w-0 lg:flex-1">
           {Faq&& <a href="#">
              ...
              <img className="h-8 w-auto sm:h-10" src={`http://34.136.73.77:1339${Faq.logo.data[0].attributes.url}`} alt="" width={100} height={100}/>
            </a>}
          </div>  
